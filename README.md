...
- `login.html` — login e criação de perfil local
...
O progresso de cada anime pode ser informado manualmente ou avançado pelo botão `+`. Tomb Raider King e Dorohedoro possuem 12 episódios cada. Notas, votos e membros usam somente os perfis locais do Nakama e começam em zero.

Cada episódio assistido concede 20 XP. O level do perfil não possui limite fixo e utiliza uma curva crescente inspirada na fórmula de experiência do Tibia.
